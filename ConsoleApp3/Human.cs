...
namespace Company
{
    abstract class Human
    {
        ...
        private DateTime _birthDate;//DateTime- для представления даты, TimeSpan - для более точного времени до секунд, StopWatch - для миллисекунд
